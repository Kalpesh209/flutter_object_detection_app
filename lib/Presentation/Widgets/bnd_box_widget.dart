...
class BndBoxWidget extends StatelessWidget {
  ...
  const BndBoxWidget(this.results, this.previewH, this.previewW, this.screenH,
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: model == AppStrings.mobilenet
          ? renderStrings()
          : model == AppStrings.posenet
              ? renderKeypoints()
              : renderBoxes(),
    );
  }
